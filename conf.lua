function love.conf(t)
	...
	t.window.title = "Reversi"         -- The window title (string)
	t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
	t.window.width = --[[320]] 320           -- The window width (number)
	t.window.height = --[[480]] 480      -- The window height (number)
	...
	t.window.y = 2                    -- The y-coordinate of the window's position in the specified display (number)
